...
const FRAUD_TREND = [
  { date: 'Aug 10', total: 1820, fraud: 38 },
  { date: 'Aug 11', total: 2140, fraud: 41 },
  { date: 'Aug 12', total: 1980, fraud: 35 },
  { date: 'Aug 13', total: 2450, fraud: 52 },
  { date: 'Aug 14', total: 2890, fraud: 49 },
  { date: 'Aug 15', total: 3120, fraud: 62 },
  { date: 'Aug 16', total: 3450, fraud: 58 },
  { date: 'Aug 17', total: 2560, fraud: 47 },
];

const FRAUD_BY_DEVICE = [
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
        <Section title="Fraud by Device" sub="Fraud count per device type">
        ...
        <Section title="Fraud by Transaction Type" sub="Safe vs fraud split">
          <ResponsiveContainer width="100%" height={200}>
